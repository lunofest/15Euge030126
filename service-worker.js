const CACHE_NAME = 'cache-v36'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v36',
    'estilos/styles.css?v36',
    'estilos/mediaQueries.css?v36',
    'javascript/script.js?v36',
