...
function updateTimer() {
    const targetDate = new Date("january 3, 2026 21:00:00").getTime();
...
(function () {
    ...
    if (confirmBtn && nombreInput && mensajeInput) {
        confirmBtn.addEventListener('click', function () {
            ...
            const numeroWhatsapp = '543875014237';
...
if (playlistBtn && lightboxPlaylist) {
    ...
    const whatsappNumber = '542236207688'; // Cambia aquí el número si lo necesitas
